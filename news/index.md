...
- Added support for a fixed numeric value to the `where` argument in
  `geom_tukey`, allowing letters to be placed at a specified y-position
  instead of a computed statistic.
