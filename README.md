...
<!-- badges: start -->
  ...
  [![Last commit](https://img.shields.io/github/last-commit/ethanbass/ggtukey)](https://github.com/ethanbass/ggtukey/)
...
Bass, E. (2026). ggtukey: Compact Letter Displays for 'ggplot2' (v0.5.1). (https://ethanbass.github.io/ggtukey/). 
